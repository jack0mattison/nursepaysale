...
export default function SignupPage() {
  ...
  return (
    <div className="mx-auto max-w-md px-4 py-12">
      ...
      <p className="mt-1 text-text-secondary">Create an account to subscribe to Pro and use AI career tools.</p>
      ...
      <p className="mt-4 text-center text-sm text-text-secondary">
        ...
        <Link href="/auth/login" className="text-primary-light hover:underline">Log in</Link>
      </p>
    </div>
  );
}
